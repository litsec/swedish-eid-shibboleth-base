...
/**
 * Lookup function for finding a {@link AuthnContextClassContext}.
 * 
 * @author Martin Lindström (martin.lindstrom@litsec.se)
 */
public class AuthnContextClassContextLookup implements ContextDataLookupFunction<AuthenticationContext, AuthnContextClassContext> {

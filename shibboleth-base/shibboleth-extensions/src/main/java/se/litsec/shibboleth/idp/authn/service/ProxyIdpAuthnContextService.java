...
public interface ProxyIdpAuthnContextService extends AuthnContextService {
   ...
   */
  List<String> getSendAuthnContextClassRefs(ProfileRequestContext<?, ?> context, List<String> assuranceURIs)
      throws ExternalAutenticationErrorCodeException;
   ...
   */
  @Override
  default List<String> getPossibleAuthnContextClassRefs(ProfileRequestContext<?, ?> context)
      throws ExternalAutenticationErrorCodeException {
